...
// fn distance_arcsec(coord1: &CoordinateEquatorial, coord2: &CoordinateEquatorial) -> f64 {
//     let diff_ra_h = coord1.ra.to_hours() - coord2.ra.to_hours();
//     let diff_dec_deg = coord1.dec.to_degrees() - coord2.dec.to_degrees();
//     (diff_ra_h * 15.0).hypot(diff_dec_deg) * 3600.0
// }
...
//         let diff_ra_h_iter = target_ra - solved_ra;
//         let diff_dec_deg_iter = target_dec - solved_dec;
...
//         // println!("DEBUG: Iteration {} - Solved RA: {:.4}h, Dec: {:.4}°", i + 1, solved_ra, solved_dec);
