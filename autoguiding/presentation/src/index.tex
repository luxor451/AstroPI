...
\begin{frame}{System Architecture}
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item \textbf{Runtime:} \href{https://tokio.rs/}{\texttt{Tokio}} (Async event loop, 10Hz cycle)
            \item \textbf{Web Server:} \href{https://docs.rs/axum/latest/axum/}{\texttt{Axum}} (Telemetry \& Control UI)
            \item \textbf{Math:} \href{https://nalgebra.rs/}{\texttt{Nalgebra}} (Linear algebra for FGF)
        \end{itemize}
